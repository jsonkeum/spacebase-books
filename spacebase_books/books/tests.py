...
class BooksViewTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        u1 = User.objects.create_user(username="abdullah", email="abdullah@gmail.com", password="123456")
        u2 = User.objects.create_user(username="bob", email="bob@gmail.com", password="123456")
        # User.objects.create_user(username="carol", email="carol@gmail.com", password="123456")
        # User.objects.create_user(username="dinah", email="dinah@gmail.com", password="123456")
...
class DashboardViewTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        users = [
            ...
            User.objects.create_user(username="carol", email="carol@gmail.com", password="123456"),
            User.objects.create_user(username="dinah", email="dinah@gmail.com", password="123456"),
            User.objects.create_user(username="earl", email="earl@gmail.com", password="123456"),
            User.objects.create_user(username="frank", email="frank@gmail.com", password="123456"),
            User.objects.create_user(username="greta", email="greta@gmail.com", password="123456"),
            User.objects.create_user(username="helen", email="helen@gmail.com", password="123456"),
            User.objects.create_user(username="irene", email="irene@gmail.com", password="123456"),
            User.objects.create_user(username="jason", email="jason@gmail.com", password="123456"),
        ]
    ...
    def test_most_read_list(self):
        ...
        self.assertQuerysetEqual(response.context['dashboard_lists']['most_read'], [
    ...
    def test_top_rated_list(self):
        ...
        self.assertQuerysetEqual(response.context['dashboard_lists']['top_rated'], [
